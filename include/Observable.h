...
class Observable
{
	public:
		...
		int clearPeriod; // number of timesteos between two writeBufferToFile
		// buffer is declared by children
		virtual void record(std::vector<Particle> activeParticles, unsigned long int t); // write data to buffer
