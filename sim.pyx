...
# distutils: sources = src/Observable.cpp src/Simulation.cpp src/Particle.cpp src/Random.cpp src/Potential.cpp src/Trajectory.cpp src/RadialDistribution.cpp src/utils.cpp
